...
```bash
git clone https://github.com/yourusername/rajendra_jat.git
cd rajendra_jat
```
...
Your Name
- GitHub: [@rajendra-jat7](https://github.com/rajendra-jat7)
- LinkedIn: [Rajendra Jat](https://www.linkedin.com/in/rajendra-jat/)
